    ...
    datasets: [
      {
        ...
        backgroundColor: ["rgba(255, 99, 132, 0.2)", "rgba(54, 162, 235, 0.2)", "rgba(255, 206, 86, 0.2)"], // Example color variations
        borderColor: ["#000", "rgba(54, 162, 235, 1)", "rgba(255, 206, 86, 1)"], // Example border colors
        pointBackgroundColor: ["rgba(255, 99, 132, 1)", "rgba(54, 162, 235, 1)", "rgba(255, 206, 86, 1)"], // Example point colors
