    ...
    <div>
      <CartContent>
        ...
        <Cartleftcontainer>
          ...
          <CartleftcontainerText>
            ...
            <p className="cart-item-total">
              Total: ₦{cartItem.productTotal?.toLocaleString()}
            </p>
            <p className="productPrice">
              u/p: ₦{cartItem.productPrice?.toLocaleString()}
            </p>
        ...
        <CartRightContainer>
          <CartUpdateAndDeleteBtns>
            <div
              className="move-to-wishlist-button"
              onClick={() => handleMoveToWishList(cartItem?.productId)}
            >
              Move To WishList
            </div>
            <AlternateAddToCartButton
              buttonText={`UPDATE`}
